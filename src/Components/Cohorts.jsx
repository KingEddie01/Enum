...
import CohortList from './CohortList';  // Make sure CohortList is imported if it's used
      ...
      <Card key={index}
        ...
        <CardContent className={classes.cardcover}>
          <div className={classes.firstChild}>
            <img src={user.image} alt='image' style={{ width: "sm" }} />
            <div className={classes.secondChild}>
              ...
              <div className={classes.child}>
                ...
                <Typography variant="body2" color="text.secondary">
                  {user.numberOflearners} Learners
                </Typography>
              </div>
            </div>
          </div>
